const En = {
  ...
  form: {
    ...
    requiredMark: "Whether to Sshow Require mark",
  ...
  fetch: {
    ...
    parseInfo:
      "Parse the interface data and return the data structure required by the component",
  ...
  designer: {
    ...
    clearCancel: "Cancel",
    clearConfirmTitle:
      "It will not be restored after cleared, are you sure you want to clear it? ",
    config: {
      component: "Component",
      form: "Form",
      rule: "Basic",
  ...
  components: {
    ...
    checkbox: {
      ...
      props: {
        ...
        textColor:
          "The text color of the checkbox in the button form when it is activated",
    ...
    select: {
      ...
      props: {
        ...
        maxTagCount:
          "Whether to display the selected value in the form of text when multiple selection",
        placeholder: "Placeholder",
        ...
        remoteInfo:
          "Note that if remote is set, filter & create new options won't work on options",
        onSearch: "Callback triggered when a search is conducted",
        clearFilterAfterSelect:
          "When multiple and filter is true, whether to clear filter keyword after select an option",
    ...
    rate: {
      ...
      props: {
        ...
        clearableInfo:
          "Value will be set to null if you click on current value's corresponding icon",
    ...
    colorPicker: {
      ...
      props: {
        ...
        modesInfo:
          "Notice that value will follow the mode once you select a new value from the picker",
      },
    },
    row: {
      name: "Grid Layout",
    ...
    tab: {
      ...
      props: {
        ...
        defaultValueInfo:
          "After modifying the corresponding tab logo, the value needs to be updated at the same time",
    ...
    "tab-pane": {
      ...
      props: {
        ...
        closable: "Whether to allow the tag to be closed",
        nameInfo:
          "Modifying the identity needs to update the identity of the parent component synchronously",
        closableInfo: "Only works when the tag's type is card",
        ...
        showLazy:
          "tab-panel's content will be lazily loaded && won't be reset after tab changes",
      },
    },
    "t-divider": {
      name: "Divider",
    ...
    cascader: {
      ...
      props: {
        ...
        parentInfo:
          "when all child node are checked (not working in single select mode)",
    ...
    upload: {
      ...
      props: {
        ...
        withCredentials:
          "Any credentials to be sent with the request (e.g. cookie)",
        accept:
          "Accept the uploaded file type (this parameter is invalid in thumbnail-mode mode)",
        acceptInfo:
          "Reference https://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/input/file#accept",
        ...
        showPreviewButtonInfo:
          "when list-type is image-card). Use the on-preview callback for this event",
      },
    },
    "t-transfer": {
      name: "Transfer",
    ...
    tree: {
      ...
      props: {
        ...
        checkStrategyInfo:
          "The strategy of setting checked callback's keys argument",
